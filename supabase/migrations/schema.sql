...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.ai_channels (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.card_history (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.card_reviews (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.card_tags (
    card_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.card_versions (
    id uuid DEFAULT extensions.uuid_generate_v4() NOT NULL,
    main_card_id uuid,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.categories (
    id uuid DEFAULT extensions.uuid_generate_v4() NOT NULL,
    name text NOT NULL,
    description text,
    color text,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.character_cards (
    id uuid DEFAULT extensions.uuid_generate_v4() NOT NULL,
    file_hash text,
    file_name text,
    file_size integer,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.chat_sessions (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    card_id uuid,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.collection_cards (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.collections (
    id uuid DEFAULT extensions.uuid_generate_v4() NOT NULL,
    name text NOT NULL,
    description text,
    cover_card_id uuid,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.play_sessions (
    id uuid DEFAULT extensions.uuid_generate_v4() NOT NULL,
    card_id uuid,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.regex_rules (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    card_id uuid,
    name text NOT NULL,
    regex text NOT NULL,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.settings (
    key text NOT NULL,
    value jsonb,
    updated_at timestamp with time zone DEFAULT now()
);
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.shared_links (
    id uuid DEFAULT extensions.uuid_generate_v4() NOT NULL,
    token text NOT NULL,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.user_settings (
...
CREATE INDEX IF NOT EXISTS idx_character_cards_category_id ON public.character_cards USING btree (category_id);
...
CREATE INDEX IF NOT EXISTS idx_character_cards_created_at ON public.character_cards USING btree (created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_character_cards_data ON public.character_cards USING gin (data);
...
CREATE INDEX IF NOT EXISTS idx_character_cards_is_favorite ON public.character_cards USING btree (is_favorite);
...
CREATE INDEX IF NOT EXISTS idx_character_cards_is_nsfw ON public.character_cards USING btree (is_nsfw);
...
CREATE INDEX IF NOT EXISTS idx_character_cards_name ON public.character_cards USING btree (name);
...
CREATE INDEX IF NOT EXISTS idx_character_cards_user_rating ON public.character_cards USING btree (user_rating DESC);
...
CREATE INDEX IF NOT EXISTS idx_chat_sessions_card_id ON public.chat_sessions USING btree (card_id);
...
CREATE INDEX IF NOT EXISTS idx_shared_links_token ON public.shared_links USING btree (token);
